...
**See [backend-patterns.md](../skills/databricks-app-apx/backend-patterns.md) for complete code templates.**
...
**See [backend-patterns.md](../skills/databricks-app-apx/backend-patterns.md) for complete CRUD templates.**
...
**See [frontend-patterns.md](../skills/databricks-app-apx/frontend-patterns.md) for complete page templates.**
...
- **[backend-patterns.md](../skills/databricks-app-apx/backend-patterns.md)** - Complete backend code templates
- **[frontend-patterns.md](../skills/databricks-app-apx/frontend-patterns.md)** - Complete frontend page templates
- **[best-practices.md](../skills/databricks-app-apx/best-practices.md)** - Best practices, anti-patterns, debugging

Read these files only when actively writing that type of code or debugging issues.

## Related Skills

- **[databricks-app-python](../skills/databricks-app-python/SKILL.md)** - for Streamlit, Dash, Gradio, or Flask apps
- **[databricks-asset-bundles](../skills/databricks-asset-bundles/SKILL.md)** - deploying APX apps via DABs
- **[databricks-python-sdk](../skills/databricks-python-sdk/SKILL.md)** - backend SDK integration
- **[databricks-lakebase-provisioned](../skills/databricks-lakebase-provisioned/SKILL.md)** - adding persistent PostgreSQL state to apps
