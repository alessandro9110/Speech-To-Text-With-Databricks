...
- **[databricks-genie](../skills/databricks-genie/SKILL.md)** - Comprehensive Genie Space creation, curation, and Conversation API guidance
- **[databricks-unstructured-pdf-generation](../skills/databricks-unstructured-pdf-generation/SKILL.md)** - Generate synthetic PDFs to feed into Knowledge Assistants
- **[databricks-synthetic-data-generation](../skills/databricks-synthetic-data-generation/SKILL.md)** - Create raw data for Genie Space tables
- **[databricks-spark-declarative-pipelines](../skills/databricks-spark-declarative-pipelines/SKILL.md)** - Build bronze/silver/gold tables consumed by Genie Spaces
- **[databricks-model-serving](../skills/databricks-model-serving/SKILL.md)** - Deploy custom agent endpoints used as MAS agents
- **[databricks-vector-search](../skills/databricks-vector-search/SKILL.md)** - Build vector indexes for RAG applications paired with KAs

## See Also

- `../skills/databricks-agent-bricks/1-knowledge-assistants.md` - Detailed KA patterns and examples
- `databricks-genie` skill - Detailed Genie patterns, curation, and examples
- `../skills/databricks-agent-bricks/2-supervisor-agents.md` - Detailed MAS patterns and examples
