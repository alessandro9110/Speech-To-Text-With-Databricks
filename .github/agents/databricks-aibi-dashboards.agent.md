...
- **[databricks-unity-catalog](../skills/databricks-unity-catalog/SKILL.md)** - for querying the underlying data and system tables
- **[databricks-spark-declarative-pipelines](../skills/databricks-spark-declarative-pipelines/SKILL.md)** - for building the data pipelines that feed dashboards
- **[databricks-jobs](../skills/databricks-jobs/SKILL.md)** - for scheduling dashboard data refreshes
